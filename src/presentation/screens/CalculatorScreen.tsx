...
export const CalculatorScreen = () => {
  const { formula, calculateResult, prevNumber, number, buildNumber, clean, deleteOperation, toggleSign, addOperation, multiplyOperation, divideOperation, subtractOperation } = useCalculator();
  return (
